  ...
  (function n(v, m, c) {
    ...
    4: [function (n, v, m) {
      ...
      function k(g, l, b, a) {
        ...
        a = g.length;
        if (!(l >= a)) return b ? (b = g[l], l + 1 < a && (b |= g[l + 1] << 8)) : (b = g[l] << 8, l + 1 < a && (b |= g[l + 1])), b;
      }
      function q(g, l, b, a) {
      ...
      function r(g, l, b, a, c) {
        ...
        var x = g.length;
        if (!(b >= x)) for (c = 0, x = Math.min(x - b, 2); c < x; c++) g[b + c] = (l & 255 << 8 * (a ? c : 1 - c)) >>> 8 * (a ? c : 1 - c);
      }
      ...
      c.prototype.toString = function (g, b, a) {
        ...
        switch (g) {
          ...
          case "utf-8":
            var c = g = "";
            for (a = Math.min(this.length, a); b < a; b++) 127 >= this[b] ? (g += F(c) + String.fromCharCode(this[b]), c = "") : c += "%" + this[b].toString(16);
            a = g + F(c);
            break;
          case "ascii":
            a = d(this, b, a);
      ...
      c.prototype.slice = function (b, a) {
        ...
        g = a - b;
        for (var f = new c(g, void 0, !0), l = 0; l < g; l++) f[l] = this[l + b];
        return f;
      };
      ...
      c.prototype.readInt8 = function (b, a) {
        a || (p(void 0 !== b && null !== b, "missing offset"), p(b < this.length, "Trying to read beyond buffer length"));
        if (!(b >= this.length)) return this[b] & 128 ? -1 * (255 - this[b] + 1) : this[b];
      };
      ...
      c.prototype.fill = function (b, a, f) {
        ...
        p(f >= a, "end < start");
        if (f !== a && 0 !== this.length) for (p(0 <= a && a < this.length, "start out of bounds"), p(0 <= f && f <= this.length, "end out of bounds"); a < f; a++) this[a] = b;
      };
    ...
    14: [function (n, v, m) {
      ...
      c.prototype.allGeneratedPositionsFor = function (b) {
        ...
        if (0 <= d) {
          ...
          }), h = this._originalMappings[++d];else for (b = h.originalColumn; h && h.originalLine === c && h.originalColumn == b;) t.push({
            line: e.getArg(h, "generatedLine", null),
            column: e.getArg(h, "generatedColumn", null),
            lastColumn: e.getArg(h, "lastGeneratedColumn", null)
      ...
      d.prototype._parseMappings = function (b, a) {
        for (var c = 1, f = 0, d = 0, h = 0, m = 0, q = 0, n = b.length, y = 0, v = {}, A = {}, F = [], H = [], z, E, p, D, J; y < n;) if (";" === b.charAt(y)) c++, y++, f = 0;else if ("," === b.charAt(y)) y++;else {
          ...
          if (p = v[E]) y += E.length;else {
            for (p = []; y < D;) u.decode(b, y, A), J = A.value, y = A.rest, p.push(J);
      ...
      q.prototype._parseMappings = function (a, c) {
        ...
        for (var b = 0; b < this._sections.length; b++) for (var f = this._sections[b], d = f.consumer._generatedMappings, h = 0; h < d.length; h++) {
          var k = d[h],
    ...
    15: [function (n, v, m) {
      ...
      c.prototype._validateMapping = function (a, c, e, d) {
        if (!(a && "line" in a && "column" in a && 0 < a.line && 0 <= a.column && !c && !e && !d || a && "line" in a && "column" in a && c && "line" in c && "column" in c && 0 < a.line && 0 <= a.column && 0 < c.line && 0 <= c.column && e)) throw Error("Invalid mapping: " + JSON.stringify({
          generated: a,
          source: e,
          original: c,
          name: d
    ...
    16: [function (n, v, m) {
      ...
      c.prototype.prepend = function (c) {
        if (Array.isArray(c)) for (var a = c.length - 1; 0 <= a; a--) this.prepend(c[a]);else if (c.$$$isSourceNode$$$ || "string" === typeof c) this.children.unshift(c);else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + c);
        return this;
      };
      ...
      c.prototype.walkSourceContents = function (c) {
        for (var a = 0, e = this.children.length; a < e; a++) this.children[a].$$$isSourceNode$$$ && this.children[a].walkSourceContents(c);
        var d = Object.keys(this.sourceContents);
        a = 0;
        for (e = d.length; a < e; a++) c(k.fromSetString(d[a]), this.sourceContents[d[a]]);
      };
      c.prototype.toString = function () {
        var c = "";
    ...
    17: [function (n, v, m) {
      ...
      function k(a) {
        ...
        a = m.isAbsolute(b);
        b = b.split(/\/+/);
        for (var k, h = 0, n = b.length - 1; 0 <= n; n--) k = b[n], "." === k ? b.splice(n, 1) : ".." === k ? h++ : 0 < h && ("" === k ? (b.splice(n + 1, h), h = 0) : (b.splice(n, 2), h--));
        b = b.join("/");
        "" === b && (b = a ? "/" : ".");
