!function (t, e) {
  ...
  class v extends i {
    ...
    addResources(t, e, s) {
      ...
      for (const i in s) "string" != typeof s[i] && "[object Array]" !== Object.prototype.toString.apply(s[i]) || this.addResource(t, e, i, s[i], {
        silent: !0
      });
    ...
    addResourceBundle(t, e, s, i, n) {
      ...
      let a = u(this.data, r) || {};
      o.skipCopy || (s = JSON.parse(JSON.stringify(s))), i ? h(a, s, n) : a = {
        ...a,
        ...s
      }, l(this.data, r, a), o.silent || this.emit("added", t, e, s);
    }
  ...
  class S extends i {
    ...
    extendTranslation(t, e, s, i, n) {
      ...
      if (this.i18nFormat && this.i18nFormat.parse) t = this.i18nFormat.parse(t, {
        ...
        if (this.options.interpolation.defaultVariables && (l = {
          ...this.options.interpolation.defaultVariables,
          ...l
        }), t = this.interpolator.interpolate(t, l, s.lng || this.language, s), r) {
          const e = t.match(this.interpolator.nestingRegexp);
    ...
    getUsedParamsDetails() {
      ...
      let i = s ? t.replace : t;
      if (s && void 0 !== t.count && (i.count = t.count), this.options.interpolation.defaultVariables && (i = {
        ...this.options.interpolation.defaultVariables,
        ...i
      }), !s) {
        i = {
  ...
  class j {
    ...
    interpolate(t, e, s, i) {
      ...
      const h = t => {
        if (t.indexOf(this.formatSeparator) < 0) {
          ...
          return this.alwaysFormat ? this.format(n, void 0, s, {
            ...i,
            ...e,
            interpolationkey: t
          }) : n;
    ...
    nest(t, e) {
      ...
      for (; s = this.nestingRegexp.exec(t);) {
        ...
        n = {
          ...r
        }, n = n.replace && "string" != typeof n.replace ? n.replace : n, n.applyPostProcessor = !1, delete n.defaultValue;
        let u = !1;
  ...
  class F extends i {
    ...
    loaded(t, e, s) {
      const i = t.split("|"),
        n = i[0],
        o = i[1];
      e && this.emit("failedLoading", n, o, e), s && this.store.addResourceBundle(n, o, s, void 0, void 0, {
        skipCopy: !0
      }), this.state[t] = e ? -1 : 2;
      const r = {};
  ...
  class U extends i {
    constructor() {
      ...
      var i;
      if (super(), this.options = A(t), this.services = {}, this.logger = s, this.modules = {
        external: []
      }, i = this, Object.getOwnPropertyNames(Object.getPrototypeOf(i)).forEach(t => {
    ...
    init() {
      ...
      if (this.options = {
        ...
        }), !e || this.options.interpolation.format && this.options.interpolation.format !== o.interpolation.format || (n.formatter = r(e), n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new j(this.options), n.utils = {
          hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
        }, n.backendConnector = new F(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", function (e) {
    ...
    cloneInstance() {
      ...
      }, s && (n.store = new v(this.store.data, i), n.services.resourceStore = n.store), n.translator = new S(n.services, i), n.translator.on("*", function (t) {
        for (var e = arguments.length, s = new Array(e > 1 ? e - 1 : 0), i = 1; i < e; i++) s[i - 1] = arguments[i];
        n.emit(t, ...s);
      }), n.init(i, e), n.translator.options = i, n.translator.backendConnector.services.utils = {
        hasLoadedNamespace: n.hasLoadedNamespace.bind(n)
      }, n;
    }
    toJSON() {
