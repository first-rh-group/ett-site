...
include('../../projeto_ett/portal/session/local_functions.php');
...
if ($_POST['action'] == 'superCoringa') {
	if ($_POST['codigo'] == '1') {
		...
		include('/Data%20Campos%20Sistemas/Apache24/htdocs/projeto_ett/data/connectionSelect.php');
		...
		if (count($erros) > 0) {
			...
			if ($count > 0) {
				...
				include('/Data%20Campos%20Sistemas/Apache24/htdocs/projeto_ett/includes/mailPrimeiroAcesso.php');
				echo json_encode(['retorno' => true]);
			} else {
