...
$pdf->MultiCell(0, 6, utf8_decode('Verifique as condições e o prazo para a apresentação da Declaração do Imposto sobre a Renda da Pessoa Física para este ano-calendário no sítio da Secretaria da Receita Federal do Brasil na Internet, no endereço <https://www.gov.br/receitafederal/pt-br>.'), $bordas, 'J');
$pdf->Ln(1.5);
$largura = 0;
$altura = 6;
$bordas = 'LRTB';
...
if ($infoRendimentos['informeRendimento']['PENSAO'] > 0) {
    ...
    $pdf->SetFont('Arial', '', 10.5);
    $bordas = 'BLR';
    $pdf->Cell(($netWidth - $linhaAuxiliar), $altura, 'Desconto anual', $bordas, 0, 'L');
    $bordas = 'BR';
    $pdf->Cell(0, $altura, 'R$ ' . printValor($infoRendimentos['informeRendimento']['PENSAO']), $bordas, 1, 'L');
    $pdf->SetFont('Arial', 'B', 10.5);
    $bordas = 'BL';
    $pdf->Ln(3);
}
