...
function _coringa() {
  _coringa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(codigo, instrucoes) {
    var instrucoesEnviadas, _i, _Object$entries, _Object$entries$_i, key, value, extra, form, novaSenhaUsuario, controle;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          console.log("Instruções enviadas: ", instrucoesEnviadas); // Adicionado para depuração
          extra = '';
