...
*/
function confereExistenciaColaborador(_x) {
  return _confereExistenciaColaborador.apply(this, arguments);
}
function _confereExistenciaColaborador() {
  _confereExistenciaColaborador = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(cpf) {
    var xmlhttp;
...
cpfUsuario === null || cpfUsuario === void 0 ? void 0 : cpfUsuario.addEventListener('keyup', function () {
  ...
  if (soNumeros(cpfUsuario.value).length == 11) {
    if (valida_CPF(cpfUsuario.value)) {
      ...
      confereExistenciaColaborador(cpfUsuario.value).then(function (retorno) {
        if (isJson(retorno)) {
