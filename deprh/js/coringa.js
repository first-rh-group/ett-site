...
function _coringa() {
  _coringa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(codigo, instrucoes) {
    var instrucoesEnviadas, _i, _Object$entries, _Object$entries$_i, key, value, extra, form, novaSenhaUsuario, controle, erros;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (instrucoes != null) {
            ...
            for (_i = 0, _Object$entries = Object.entries(instrucoes); _i < _Object$entries.length; _i++) {
          ...
          controle = formControl(alteracaoSenhaForm.id, 'respostaPadroes2');
        ...
        case 16:
          ...
          erros = formControl(instrucoes.nomeFormulario);
          if (!(erros.length > 0)) {
            _context.next = 23;
            break;
          }
            ...
            xmlhttp.onreadystatechange = function () {
              if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                if (codigo == 10) {
                  if (xmlhttp.responseText != '') {
                    ...
                    if (retornado == '') {
                      ...
                      changeAttributes({
                        ...
                        "attributes": {
                          "onclick": "coringa('11'," + JSON.stringify({
                            "nomeFormulario": "editandoInformacoesEmpregadoForm"
                          }) + ");",
                          "type": "submit"
                        }
                      });
                  ...
                  if ((obj === null || obj === void 0 ? void 0 : obj.retorno) == true && (obj === null || obj === void 0 ? void 0 : obj.idUsuario) != '') {
