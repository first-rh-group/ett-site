...
function trocaLingua(idioma) {
	...
	if(window.location.pathname == '/index.html' || window.location.pathname == '/') {
		...
		document.querySelector("#ettFirst > div > div:nth-child(2)").innerHTML = lingua.first[0];
		document.querySelector("#ettFirst > div > ul > li:nth-child(1)").innerHTML = lingua.first[1];
		document.querySelector("#ettFirst > div > ul > li:nth-child(2)").innerHTML = lingua.first[2];
		document.querySelector("#ettFirst > div > ul > li:nth-child(3)").innerHTML = lingua.first[3];

		document.querySelector("#shift > div > div:nth-child(2)").innerHTML = lingua.shift[0];
		document.querySelector("#shift > div > ul > li:nth-child(1)").innerHTML = lingua.shift[1];
		document.querySelector("#shift > div > ul > li:nth-child(2)").innerHTML = lingua.shift[2];
		document.querySelector("#shift > div > ul > li:nth-child(3)").innerHTML = lingua.shift[3];

		document.querySelector("#recruit > div > div:nth-child(2)").innerHTML = lingua.recruit[0];
		document.querySelector("#recruit > div > ul > li:nth-child(1)").innerHTML = lingua.recruit[1];
		document.querySelector("#recruit > div > ul > li:nth-child(2)").innerHTML = lingua.recruit[2];
		document.querySelector("#recruit > div > ul > li:nth-child(3)").innerHTML = lingua.recruit[3];
		...
		document.querySelector("#emBreve > div > div:nth-child(1)").innerHTML = lingua.emBreve.p1;
		document.querySelector("#emBreve > div > div:nth-child(2)").innerHTML = lingua.emBreve.p2;
		document.querySelector("#emBreve > div > div:nth-child(3)").innerHTML = lingua.emBreve.p3;
